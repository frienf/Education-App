...
import { GraduationCap, Clock, Plus, BookOpen } from "lucide-react";
    ...
    >
      ...
      >
        ...
        >
          ...
          <GraduationCap className="w-12 h-12 text-white drop-shadow-lg relative z-10" />
        </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="relative">
            <Clock className="w-5 h-5 absolute left-3 top-1/2 -translate-y-1/2 text-white" />
            <Input
              type="number"
